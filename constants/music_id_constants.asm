	...
	const MUSIC_CLAIR ; new to crystal
	...
	const MUSIC_PROF_BATTLE
	const MUSIC_POKEMON_TOWER
	const MUSIC_ALDER_TOWN
	const MUSIC_ROUTE_32
	const MUSIC_GIOVANNI_ENCOUNTER
	const MUSIC_CITRINE_INN_REST
	const MUSIC_BLUE_BATTLE
	const MUSIC_DREAD_WOODS
	const MUSIC_CINNABAR_MANSION
	const MUSIC_POKEMART
	const MUSIC_CERULEAN_CAVE
	const MUSIC_SAFARI_ZONE
	const MUSIC_CREDITS_G1
	const MUSIC_SAFARI_ZONE_GATE
	const MUSIC_FINAL_POKEMON
	const MUSIC_MEWTWO_BATTLE
	const MUSIC_HO_OH_BATTLE
	const MUSIC_LUGIA_BATTLE
	const MUSIC_LUGIAS_SONG
	const MUSIC_KANTO_BIRDS_BATTLE
	const MUSIC_IMAKUNI_THEME
	const MUSIC_ELITE_FOUR_BATTLE
	const MUSIC_BW_BETA_WILD_BATTLE
