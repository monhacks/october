...
; ANIM_OBJ_WATER_SPOUT_FALLING
	...
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_MAGNET_BOMB, BATTLE_ANIM_FUNC_HIDDEN_POWER, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS
; ANIM_OBJ_MAGNET_BOMB_IMPACT
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_MAGNET_BOMB, BATTLE_ANIM_FUNC_RADIAL_MOVE_IN, PAL_BATTLE_OB_GRAY, ANIM_GFX_ROCKS
