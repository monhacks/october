...
; BATTLE_ANIM_OBJ_LAVA_PLUME_BURST_SMOKE
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_LAVA_BURST_SMOKE, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_GRAY, ANIM_GFX_SMOKE_PUFF_BIG